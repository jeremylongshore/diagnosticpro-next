...
declare namespace axe {
  ...
  interface Check {
    ...
    after?: string | ((results: AfterResult[], options: unknown) => AfterResult[]);
    options?: any;
    matches?: string;
    enabled?: boolean;
    metadata?: {
  ...
  interface DqElement extends SerialDqElement {
    ...
    mergeSpecs(childSpec: SerialDqElement, parentSpec: SerialDqElement): SerialDqElement;
  }
  ...
  interface Utils {
    ...
    isLabelledFramesSelector: (selector: unknown) => selector is LabelledFramesSelector;
    isLabelledShadowDomSelector: (selector: unknown) => selector is LabelledShadowDomSelector;

    DqElement: new (elm: Element, options?: { absolutePaths?: boolean }) => DqElement;
    uuid: (
