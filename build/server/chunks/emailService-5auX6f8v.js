...
class AIAnalysisService {
  ...
  async initialize() {
    ...
    try {
      ...
      console.log("✅ Vertex AI Gemini initialized (backup)");
    ...
    try {
      ...
      if (!this.useOpenAI) {
        try {
          ...
          console.warn("⚠️ Gemini failed, details:", geminiError.message);
...
export { AIAnalysisService$1 as A, EmailService$1 as E };
//# sourceMappingURL=emailService-5auX6f8v.js.map
